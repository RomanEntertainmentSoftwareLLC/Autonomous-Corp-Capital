...
def load_company_values(target_scope: str) -> Dict[str, Any]:
    if not target_scope or not str(target_scope).startswith("company_"):
        return {}

    candidates = [
        ROOT.parent / "workspaces" / "companies" / target_scope / "COMPANY_VALUES.md",
        ROOT / "workspaces" / "companies" / target_scope / "COMPANY_VALUES.md",
        ROOT.parent / "workspace" / "companies" / target_scope / "COMPANY_VALUES.md",
        ROOT / "workspace" / "companies" / target_scope / "COMPANY_VALUES.md",
        Path("/opt/openclaw/.openclaw/workspaces/companies") / target_scope / "COMPANY_VALUES.md",
        Path("/opt/openclaw/.openclaw/workspace/companies") / target_scope / "COMPANY_VALUES.md",
    ]
